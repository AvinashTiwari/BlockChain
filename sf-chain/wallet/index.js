...
calculateBalance(blockchain) {
  ...
  const walletPushTs =  transactions.filter(transaction => transaction.input.address === this.publicKey);
  let startTime = 0;

  if(walletPushTs.length > 0  ){
  const recentInputTs = walletPushTs.reduce(
